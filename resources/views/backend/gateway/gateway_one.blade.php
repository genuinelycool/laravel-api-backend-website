            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('update.geteway.one') }}" method="post" class="row g-3"
                                ...
                                <div class="col-md-6">
                                    <label for="validationDefault01" class="form-label">GetOne Image</label>
                                    <input type="file" name="image" class="form-control" id="image">
                                </div>

                                <div class="col-md-6">
                                    <img id="showImage" src="{{ asset($getone->image) }}"
