...
@section('admin')
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="myForm" action="{{ route('update.service') }}" method="post" class="row g-3"
                                ...
                                <div class="col-md-6">
                                    <img id="showImage" src="{{ asset($service->image) }}"
    ...
    <script>
        ...
        // Set the initial content of the editor if available
